 ...
 *
 * Class Api
 * @package szj\WechatPhpSdk
 */
 
namespace szj\WechatPhpSdk;

use szj\WechatPhpSdk\Utils\HttpCurl;
use szj\WechatPhpSdk\Utils\Error;
use szj\WechatPhpSdk\Utils\SHA1;
use szj\WechatPhpSdk\Utils\Xml;
...
class Api 
{
    ...
    {
        return $this->get_access_token_diy;
    }
